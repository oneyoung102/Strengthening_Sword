...
/////////////////////////////////////////////////////////////////////////
void textcolor(int foreground, int background) //越切事 
{ 
...
///////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
void Cursorview()             //朕辞 肢薦 
{
    CONSOLE_CURSOR_INFO cursorInfo = { 0, };
    cursorInfo.dwSize = 1; //朕辞 噂奄 (1 ~ 100)
    cursorInfo.bVisible = FALSE; //朕辞 Visible TRUE(左績) FALSE(需沿)
...
void Human(int color, int x){
	Write(color,BLACK,6+x,3,"ΓΑΑΔ ");
	Write(color,BLACK,6+x,4,"Β..Β ");
	Write(color,BLACK,4+x,5,"ΓΑΕ  ΖΑΔ ");
	Write(color,BLACK,4+x,6,"Β      Β ");
	Write(color,BLACK,4+x,7,"Β      Β ");
	Write(color,BLACK,4+x,8,"ΖΑΔ  ΓΑΕ ");
	Write(color,BLACK,6+x,9,"Β  Β ");
	Write(color,BLACK,6+x,10,"Β  Β ");
	Write(color,BLACK,6+x,11,"ΖΑΑΕ ");
}
...
int main(){
vector<string> level_name = {"ュ   ","ュ+","ュ++","ュ+++","ヴ   ","ヴ+ ","ヴ++","ヴ+++","リ   ","リ+  ","リ++ ","リ+++","ユ   ","ユ+  ","ユ++ ","ユ+++","�   ","�+  ","�++ ","�+++","ヲ   ","ヲ+  ","ヲ++ ","ヲ+++"};	 
//////////////////////////////// 
Cursorview();
////////////////////////////////
i=-3;
...
while(i<=11){
system("cls");
Write(WHITE,BLACK,2,3,"－〃=-==-==-===-==-==-=ゞ－");
Write(WHITE,BLACK,2,9,"－〃=-==-==-===-==-==-=ゞ－");
Start_sword(35-i,j);
Write(WHITE,BLACK,1.9*i+5,3,"ゞ－                        ");
Write(WHITE,BLACK,1.9*i+5,9,"ゞ－                        ");
Sleep(5);
i+=2;
}
//////////////////////////////////////////////
...
while(1){
	if(manu_select%3==0){
		Write(WHITE,BLACK,5,2,"－〃=-====-=ゞ－");
	Write(WHITE,BLACK,5,3,"� Strengthen �");
	Write(WHITE,BLACK,5,4,"－〃=-====-=ゞ－");
	}
	else{
		Write(DARKGRAY,BLACK,5,2,"－〃=-====-=ゞ－");
	Write(DARKGRAY,BLACK,5,3,"� Strengthen �");
	Write(DARKGRAY,BLACK,5,4,"－〃=-====-=ゞ－");
	}
	if(manu_select%3==1){
		Write(WHITE,BLACK,5,6,"－〃=-====-=ゞ－");
	Write(WHITE,BLACK,5,7,"�   Swords   �");
	Write(WHITE,BLACK,5,8,"－〃=-====-=ゞ－");
	}
	else{
		Write(DARKGRAY,BLACK,5,6,"－〃=-====-=ゞ－");
	Write(DARKGRAY,BLACK,5,7,"�   Swords   �");
	Write(DARKGRAY,BLACK,5,8,"－〃=-====-=ゞ－");
	}
	if(manu_select%3==2){
	    Write(WHITE,BLACK,5,10,"－〃========ゞ－");
	Write(WHITE,BLACK,5,11,"�Probability�");
	Write(WHITE,BLACK,5,12,"－〃========ゞ－");
	}
	else{
		Write(DARKGRAY,BLACK,5,10,"－〃=-====-=ゞ－");
	Write(DARKGRAY,BLACK,5,11,"�Probability�");
	Write(DARKGRAY,BLACK,5,12,"－〃=-====-=ゞ－");
	}
	if(manu_select%3==0){
...
Strengthen :
	...
	while(i<=16){
system("cls");
Write(WHITE,BLACK,2,1,"－〃=-==-==-========-==-==-=ゞ－");
Write(WHITE,BLACK,2,7,"－〃=-==-==-========-==-==-=ゞ－");
Sword(40-i,j,1);
Write(WHITE,BLACK,1.7*i+5,1,"ゞ－                            ");
Write(WHITE,BLACK,1.7*i+5,7,"ゞ－                            ");
Sleep(5); 
i+=2;
}
Sleep(150); 
...
Write(WHITE,BLACK,2,7,"－〃=-==-==-========-==-==-=ゞ－"); 
Sword(25,4,1);
Write(WHITE,BLACK,2,9,"ＳＷＯＲＤ | level ュ");
...
if(kbhit()){
		...
		i=0;
		while(i<=17){
			Write(WHITE,BLACK,2,11,"－〃=-==-==-========-==-==-=ゞ－"); 
			Write(WHITE,BLACK,1.7*i+2,11,"ゞ－                            ");
			Sleep(5);
			i+=2;
		}
		Sleep(150);
		i=0;
		while(i<=17){
			Write(WHITE,BLACK,2,20,"－〃=-==-==-========-==-==-=ゞ－"); 
			Write(WHITE,BLACK,1.7*i+2,20,"ゞ－                            ");
			Sleep(5);
			i+=2;
		}
		Sleep(150);
...
Sword :
	...
	i=0;
		while(i<=19){
			Write(WHITE,BLACK,2,1,"－〃==-==-==-==========-==-==-==ゞ－"); 
			Write(WHITE,BLACK,1.75*i+2,1,"ゞ－                            ");
			Write(WHITE,BLACK,2,13,"－〃==-==-==-==========-==-==-==ゞ－"); 
			Write(WHITE,BLACK,1.75*i+2,13,"ゞ－                            ");
			Write(WHITE,BLACK,2,19,"－〃==-==-==-==========-==-==-==ゞ－"); 
			Write(WHITE,BLACK,1.75*i+2,19,"ゞ－                            ");
			Sleep(5);
			i+=2;
		}
///////////////////////////////////////////////////////////
...
i+=1;
	...
	while(1){
		if(swo_select%4==0){
			Write(WHITE,BLACK,40,2,"－〃=-====-=ゞ－");
			Write(WHITE,BLACK,40,3,"�=-- MINE --=�");
			Write(WHITE,BLACK,40,4,"－〃=-====-=ゞ－");
		}
		else{
			Write(DARKGRAY,BLACK,40,2,"－〃=-====-=ゞ－");
			Write(DARKGRAY,BLACK,40,3,"�=-- MINE --=�");
			Write(DARKGRAY,BLACK,40,4,"－〃=-====-=ゞ－");
		}
		Write(LIGHTGRAY,BLACK,40,6,"－〃=------=ゞ－");
		if(swo_select%4==1){
			Write(WHITE,BLACK,40,8,"－〃=-====-=ゞ－");
			Write(WHITE,BLACK,40,9,"�=-- 1 st --=�");
			Write(WHITE,BLACK,40,10,"－〃=-====-=ゞ－");
		}
		else{
			Write(DARKGRAY,BLACK,40,8,"－〃=-====-=ゞ－");
			Write(DARKGRAY,BLACK,40,9,"�=-- 1 st --=�");
			Write(DARKGRAY,BLACK,40,10,"－〃=-====-=ゞ－");
		}
		if(swo_select%4==2){
			Write(WHITE,BLACK,40,12,"－〃=-====-=ゞ－");
			Write(WHITE,BLACK,40,13,"�=-- 2 nd --=�");
			Write(WHITE,BLACK,40,14,"－〃=-====-=ゞ－");
		}
		else{
			Write(DARKGRAY,BLACK,40,12,"－〃=-====-=ゞ－");
			Write(DARKGRAY,BLACK,40,13,"�=-- 2 nd --=�");
			Write(DARKGRAY,BLACK,40,14,"－〃=-====-=ゞ－");
		}
		if(swo_select%4==3){
			Write(WHITE,BLACK,40,16,"－〃=-====-=ゞ－");
			Write(WHITE,BLACK,40,17,"�=-- 3 rd --=�");
			Write(WHITE,BLACK,40,18,"－〃=-====-=ゞ－");
		}
		else{
			Write(DARKGRAY,BLACK,40,16,"－〃=-====-=ゞ－");
			Write(DARKGRAY,BLACK,40,17,"�=-- 3 rd --=�");
			Write(DARKGRAY,BLACK,40,18,"－〃=-====-=ゞ－");
		}
		textcolor(WHITE,BLACK);
		if(kbhit()){
		click=_getch();
